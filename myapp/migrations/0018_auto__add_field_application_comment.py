...
class Migration(migrations.Migration):
    ...
    def forwards(self, orm):
        # Adding field 'Application.comment'
        db.add_column(u'myapp_application', 'comment',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Application.comment'
        db.delete_column(u'myapp_application', 'comment')
