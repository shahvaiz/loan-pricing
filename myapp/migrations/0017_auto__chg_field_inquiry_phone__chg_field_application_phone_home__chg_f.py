...
class Migration(migrations.Migration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Inquiry.phone'
        db.alter_column(u'myapp_inquiry', 'phone', self.gf('django.db.models.fields.CharField')(max_length=20, null=True))

        # Changing field 'Application.phone_home'
        db.alter_column(u'myapp_application', 'phone_home', self.gf('django.db.models.fields.CharField')(max_length=20, null=True))

        # Changing field 'Application.phone_work'
        db.alter_column(u'myapp_application', 'phone_work', self.gf('django.db.models.fields.CharField')(max_length=20, null=True))

        # Changing field 'Application.phone_mobile'
        db.alter_column(u'myapp_application', 'phone_mobile', self.gf('django.db.models.fields.CharField')(max_length=20, null=True))

    def backwards(self, orm):

        # Changing field 'Inquiry.phone'
        db.alter_column(u'myapp_inquiry', 'phone', self.gf('django.db.models.fields.CharField')(max_length=13, null=True))

        # Changing field 'Application.phone_home'
        db.alter_column(u'myapp_application', 'phone_home', self.gf('django.db.models.fields.CharField')(max_length=13, null=True))

        # Changing field 'Application.phone_work'
        db.alter_column(u'myapp_application', 'phone_work', self.gf('django.db.models.fields.CharField')(max_length=13, null=True))

        # Changing field 'Application.phone_mobile'
        db.alter_column(u'myapp_application', 'phone_mobile', self.gf('django.db.models.fields.CharField')(max_length=13, null=True))
