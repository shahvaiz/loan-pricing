...
def investor_adjustment (investor, loan_amount, property_value, credit_score, loan_type, property_type, state, prog_id):
	...
	if investor == "impac":
		...
		#hi = calculate_adjustment_parkside(loan_amount, property_value, credit_score, loan_type, property_type, state, prog_id)
		return calculate_adjustment_parkside(loan_amount, property_value, credit_score, loan_type, property_type, state, prog_id)
